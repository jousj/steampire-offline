package flashx.textLayout.elements
{
   ...
   public final class ParagraphElement extends ParagraphFormattedElement
   {
      ...
      public function ParagraphElement()
      {
         ...
         this.private::_interactiveChildrenCount = 0;
      }
      ...
      {
         return this.private::_interactiveChildrenCount;
      }
      ...
      override public function getText(param1:int = 0, param2:int = -1, param3:String = "\n") : String
      {
         ...
         {
            if(Boolean(this._textBlock.content) && Boolean(this._textBlock.content.rawText))
            {
      ...
      {
         ++this.private::_interactiveChildrenCount;
      }
      ...
      {
         return this.private::_interactiveChildrenCount != 0;
      }
   }
}
