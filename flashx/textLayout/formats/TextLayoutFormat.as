package flashx.textLayout.formats
{
   ...
   public class TextLayoutFormat implements ITextLayoutFormat
   {
      ...
      public static function get backgroundColorProperty() : Property
      {
         ...
         {
            _backgroundColorProperty = Property.NewUintOrEnumProperty("backgroundColor",BackgroundColor.TRANSPARENT,false,Vector.<String>([Category.CHARACTER]),BackgroundColor.TRANSPARENT);
         }
      ...
      public static function get textAlignProperty() : Property
      {
         ...
         {
            _textAlignProperty = Property.NewEnumStringProperty("textAlign",TextAlign.START,true,Vector.<String>([Category.PARAGRAPH]),TextAlign.LEFT,TextAlign.RIGHT,TextAlign.CENTER,TextAlign.JUSTIFY,TextAlign.START,TextAlign.END);
         }
      ...
      public static function get directionProperty() : Property
      {
         ...
         {
            _directionProperty = Property.NewEnumStringProperty("direction",Direction.LTR,true,Vector.<String>([Category.PARAGRAPH]),Direction.LTR,Direction.RTL);
         }
      ...
      public static function get verticalAlignProperty() : Property
      {
         ...
         {
            _verticalAlignProperty = Property.NewEnumStringProperty("verticalAlign",VerticalAlign.TOP,false,Vector.<String>([Category.CONTAINER]),VerticalAlign.TOP,VerticalAlign.MIDDLE,VerticalAlign.BOTTOM,VerticalAlign.JUSTIFY);
         }
      ...
      public static function get lineBreakProperty() : Property
      {
         ...
         {
            _lineBreakProperty = Property.NewEnumStringProperty("lineBreak",LineBreak.TO_FIT,false,Vector.<String>([Category.CONTAINER]),LineBreak.EXPLICIT,LineBreak.TO_FIT);
         }
