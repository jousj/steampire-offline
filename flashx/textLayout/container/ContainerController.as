   ...
   public class ContainerController implements IInteractionEventHandler, ITextLayoutFormat, ISandboxSupport
   {
      ...
      tlf_internal function gatherVisibleLines(param1:String, param2:Boolean) : void
      {
         ...
         if(this._textLength != 0)
         {
            ...
            _loc5_ = param1 == BlockProgression.RL ? this._xScroll - _loc3_ : this._xScroll;
      ...
      public function scrollToRange(param1:int, param2:int) : void
      {
         ...
         var _loc5_:Boolean = this.effectiveBlockProgression == BlockProgression.RL;
      ...
      public function getScrollDelta(param1:int) : Number
      {
         ...
         var _loc8_:Boolean = this.effectiveBlockProgression == BlockProgression.RL;
         if(_loc8_)
         {
      ...
      public function mouseWheelHandler(param1:MouseEvent) : void
      {
         ...
         var _loc2_:Boolean = this.effectiveBlockProgression == BlockProgression.RL;
         if(_loc2_)
         {
      ...
      tlf_internal function addSelectionShapes(param1:SelectionFormat, param2:int, param3:int) : void
      {
         ...
         if(param2 != param3)
         {
            ...
            while(_loc12_ <= _loc9_)
            {
               ...
               _loc11_.hiliteBlockSelection(_loc10_,param1,this._container,param2 < _loc11_.absoluteStart ? _loc11_.absoluteStart : param2,param3 > _loc11_.absoluteStart + _loc11_.textLength ? int(_loc11_.absoluteStart + _loc11_.textLength) : param3,_loc4_,_loc5_);
               _loc13_ = _loc11_;
               _loc11_ = _loc5_;
               _loc4_ = _loc13_;
               _loc12_++;
      ...
      tlf_internal function updateCompositionShapes() : void
      {
         ...
         this._mouseEventManager.updateHitTests(this.effectiveBlockProgression == BlockProgression.RL && this._hasScrollRect ? this._contentWidth : 0,scratchRectangle,_loc9_,_loc11_ ? _loc11_.absoluteStart : this._absoluteStart,_loc12_ ? int(_loc12_.absoluteStart + _loc12_.textLength - 1) : this._absoluteStart,this,_loc10_);
      ...
      tlf_internal function updateGraphics(param1:int) : void
      {
         ...
         var _loc17_:* = this.findFloatIndexAtOrAfter(param1);
         var _loc18_:* = 0;
         ...
         while(_loc18_ < this._floatsInContainer.length)
         {
            ...
            if(Boolean(_loc5_.parent) && _loc3_.indexOf(_loc5_) < 0)
            {
      ...
      private function removeAndRecycleTextLines(param1:int, param2:int) : void
      {
         ...
         if(Boolean(_loc5_) && (_loc5_.lastLine == _loc4_ || this.flowComposer.getControllerAt(this.flowComposer.numControllers - 1) == this))
         {
            this.releaseLinesInBlock(_loc5_);
         }
      ...
      {
         if(Boolean(param1) && param2.parent == param1)
         {
      ...
      tlf_internal function testLineVisible(param1:String, param2:int, param3:int, param4:int, param5:int, param6:TextFlowLine, param7:TextLine) : *
      {
         ...
         if(param6.controller == null)
         {
            ...
            while(_loc11_ < _loc9_.length)
            {
               ...
               if(!((Boolean(_loc10_)) && _loc10_.getAbsoluteStart() < param6.absoluteStart))
               {
                  break;
               }
         ...
         var _loc8_:* = (param1 == BlockProgression.TB ? this._measureHeight : this._measureWidth) ? 0 : param6.testLineVisible(param1,param2,param3,param4,param5);
